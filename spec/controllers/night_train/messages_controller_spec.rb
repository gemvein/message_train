...
describe NightTrain::MessagesController do
  ...
  describe "GET #new" do
    ...
    context 'loads message into @message' do
      subject { assigns(:message) }
      it { should be_a_new NightTrain::Message }
  ...
  describe "POST #create" do
    ...
    describe 'with valid attributes, counting' do
      it 'results in a new message' do
        expect { post :create, box_division: 'in', message: valid_attributes }.to change { NightTrain::Message.count }.by(1)
      end
    end
    describe 'with invalid params' do
      ...
      context 'loads the given message into @message' do
        subject { assigns(:message) }
        it { should be_a_new(NightTrain::Message).with(invalid_attributes) }
      end
    ...
    describe 'with invalid params, counting' do
      it 'does not result in a new message' do
        expect { post :create, box_division: 'in', message: invalid_attributes }.to_not change { NightTrain::Message.count }
      end
    end
  end
