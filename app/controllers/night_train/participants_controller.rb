module NightTrain
  class ParticipantsController < NightTrain::ApplicationController
    ...
    private
      ...
      def load_participants
        current_participant = send(NightTrain.configuration.current_user_method)
        method = NightTrain.configuration.address_book_method
