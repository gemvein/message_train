module NightTrain
  module ConversationsHelper
    ...
    def conversation_trashed_toggle(conversation)
      render partial: 'night_train/conversations/trashed_toggle', locals: { conversation: conversation }
    end

    def conversation_read_toggle(conversation)
      render partial: 'night_train/conversations/read_toggle', locals: { conversation: conversation }
    end

    def conversation_ignored_toggle(conversation)
      render partial: 'night_train/conversations/ignored_toggle', locals: { conversation: conversation }
    end

    def conversation_deleted_toggle(conversation)
      render partial: 'night_train/conversations/deleted_toggle', locals: { conversation: conversation }
    end
    ...
    def conversation_toggle(conversation, icon, mark_to_set, method, title, options = {})
      ...
      options[:title] = title
      render partial: 'night_train/conversations/toggle', locals: {
